...
def plot(history): 
    ...
    fig1 = plt.gcf()
    plt.show()
    fig1.savefig('graph/VGG19_v1_finetune_accuracy.png', dpi=100)
    ...
    fig2 = plt.gcf()
    plt.show()
    fig2.savefig('graph/VGG19_v1_finetune_loss.png', dpi=100)
...
def save_history_json(history):
    ...
    with open('history/VGG19_v1_history.json', mode='w') as f:
...
if __name__ == '__main__':
    ...
    filepath="weight/VGG19_v1_finetune.best.hdf5"
    checkpoint = ModelCheckpoint(filepath, monitor='val_loss', verbose=1, save_best_only=True,
    mode='auto')
    
    csv_logger = CSVLogger('history/VGG19_v1_history.log', append=True)
