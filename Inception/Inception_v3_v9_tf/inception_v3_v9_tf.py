...
def inception_v3_model(img_rows, img_cols, channel=1, num_class=None):
    ...
    model.load_weights('weight/inception_v3_v9_tf.hdf5')
...
def load_data():
  ...
  train_data_dir = '../../../data/output_train_split'
  validation_data_dir = '../../../data/output_val_split'
...
if __name__ == '__main__':
    ...
    num_class = 8 
    batch_size = 16 
    nb_train_samples = 9873
    nb_validation_samples = 2474
    nb_epoch = 100
    ...
    reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.2, patience=5, verbose=1, min_lr=1e-20) 
